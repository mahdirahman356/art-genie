    ...
    return (
        ...
        <div className="px-3 md:px-28 text-neutral-content">
          <div className="md:w-[85%] lg:w-[50%]">
            <h1 className="mb-5 text-4xl md:text-6xl primary border-l-8 pl-6 border-orange-500"> ArtGenie, Your Magic Brush Awaits</h1>
            ...
            <button className="cartoon-button-2 bg-orange-600 text-white py-2 px-4 text-lg font-bold rounded-3xl ml-6">Get Started</button>
          </div>
        </div>
      </div>
    );
